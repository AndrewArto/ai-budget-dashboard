...
Entries without cost.total are skipped (matching OpenClaw's own behavior).
...
class AnthropicProvider(BaseProvider):
    ...
    def fetch_usage(self, api_key: str | None, budget: float) -> UsageData:
        ...
        Returns actual dollar spend from JSONL cost.total fields.
        Entries without cost.total are skipped (matching OpenClaw behavior).
        """
